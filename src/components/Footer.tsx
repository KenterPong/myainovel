...
export default function Footer() {
  ...
  const footerLinks = {
    company: [
      ...
      { name: '我們的團隊', href: '/team' },
      { name: '職業機會', href: '/careers' },
      { name: '新聞中心', href: '/news' },
    ],
    services: [
      { name: '網頁設計', href: '/services/web-design' },
      { name: '應用程式開發', href: '/services/app-development' },
      { name: '數位行銷', href: '/services/digital-marketing' },
      { name: 'SEO 優化', href: '/services/seo' },
    ],
    support: [
      { name: '幫助中心', href: '/help' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-lg font-semibold mb-4">你的網站名稱</h3>
            <p className="text-gray-300 text-sm mb-4">
              我們致力於提供最優質的服務，幫助您的業務在數位世界中茁壯成長。
            </p>
